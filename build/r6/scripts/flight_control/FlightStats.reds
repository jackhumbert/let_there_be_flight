...
public static func OperatorMultiply(matrix: Matrix, vector: Vector4) -> Vector4 {
...
public static func OperatorAssignMultiply(out vector: Vector4, matrix: Matrix) -> Vector4 {
  return Vector4.Transform(matrix, vector);
}
