registerForEvent('onInit', function()
    ...
    -- Override('gamedataVehicle_Record', 'TppCameraParams', function(self)
    --     return TweakDBInterface:GetVehicleTPPCameraParamsRecord(TweakDBID.new("Camera.VehicleTPP_FlightParams"))
    -- end)
    -- Override('gamedataVehicle_Record', 'TppCameraParamsHandle', function(self)
    --     return TweakDBInterface:GetVehicleTPPCameraParamsRecord(TweakDBID.new("Camera.VehicleTPP_FlightParams"))
    -- end)
