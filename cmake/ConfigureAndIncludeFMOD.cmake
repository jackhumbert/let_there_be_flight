...
set(FMOD_GAME_DIR_DLL "${LTBF_GAME_DIR_FMOD_FOLDER}/fmod.dll")
set(FMOD_STUDIO_GAME_DIR_DLL "${LTBF_GAME_DIR_FMOD_FOLDER}/fmodstudio.dll")
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E copy_if_different ${FMOD_LIB_DIR}/x64/fmod.dll ${LTBF_GAME_DIR_FMOD_FOLDER}
)
