public class PID {
  ...
  public final static func Create(P: Float, I: Float, D: Float) -> ref<PID> {
  ...
  public final static func Create(P: Float, I: Float, D: Float, initialValue: Float) -> ref<PID> {
    let instance: ref<PID> = PID.Create(P, I, D);
    instance.valueFloat = initialValue;
    return instance;
  }
  // public final static func Create(P: Float, I: Float, D: Float, initialValue: Vector4) -> ref<PID> {
  //   let instance: ref<PID> = PID.Create(P, I, D);
  //   instance.valueVector = initialValue;
  //   return instance;
  // }
  public final func Update(P: Float, I: Float, D: Float) -> Void {
    this.P = P;
    this.I = I;
    this.D = D;
  }
  public final func SetInput(input: Float) {
    this.inputFloat = input;
  }
  // public final func SetInput(input: Vector4) {
  //   this.inputVector = input;
  // }
  public final func GetValue(timeDelta: Float) -> Float {
    let error: Float = this.inputFloat - this.valueFloat;
    this.valueFloat += this.GetCorrection(error);
    return this.valueFloat;
  } 
  public final func GetRawValue() -> Float {
    return this.valueFloat;
  } 
  // public final func GetValue(timeDelta: Float) -> Vector4 {
  //   let error: Vector4 = this.inputVector - this.valueVector;
  //   this.valueVector += this.GetCorrection(error)
  //   return this.valueVector;
  // }
  public final func GetValue(input: Float, timeDelta: Float) -> Float {
    this.SetInput(input);
    return this.GetValue(timeDelta);
  }
  // public final func GetValue(input: Vector4, timeDelta: Float) -> Vector4 {
  //   this.SetInput(input);
  //   return GetValue(timeDelta);
  // }
  public final func GetCorrection(error: Float, timeDelta: Float) -> Float { 
  ...
  // public final func GetCorrection(error: Vector4, timeDelta: Float) -> Vector4 { 
  ...
  //   return this.P * error + this.I * this.integralFloat + this.D * derivative;
  // }
  public final func GetCorrectionClamped(error: Float, timeDelta: Float, clamp: Float) -> Float {
