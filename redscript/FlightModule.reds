...
//   }
//   protected func GetForces() -> array<ref<Impulse>> {
//     return [];
//   }
//   protected func GetTorques() -> array<ref<Impulse>> {
//     return [];
//   }
...
//     impulseEvent.worldImpulse = Vector4.Vector4To3(direction * timeDelta);
//     this.GetVehicle().QueueEvent(impulseEvent);
//   }
//   protected func ApplyTorque(torque: Torque) {
