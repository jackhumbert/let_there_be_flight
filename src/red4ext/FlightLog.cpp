...
struct FlightLogModule : FlightModule {
  static void RegisterTypes();
  static void PostRegisterTypes();
};

REGISTER_FLIGHT_MODULE(FlightLogModule);

RED4ext::TTypedClass<FlightLog> flightLogCls("FlightLog");

RED4ext::CClass *FlightLog::GetNativeType() { return &flightLogCls; }
