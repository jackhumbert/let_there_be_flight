...
REGISTER_FLIGHT_HOOK(bool __fastcall, TireTrackEffectStart, RED4ext::vehicle::Unk570 *unk570,
                     RED4ext::vehicle::Unk570::Unk30 *unk30, RED4ext::vehicle::MaterialFx *fxLookup,
  ...
  return TireTrackEffectStart_Original(unk570, unk30, fxLookup, a4, a5,
                                                     physicalMaterialChange || modeChanged, conditionChange, condition);
}

// trigger resource change when flight is changed
REGISTER_FLIGHT_HOOK(bool __fastcall, SkidMarkEffectStart, RED4ext::vehicle::Unk570 *unk570,
                     RED4ext::vehicle::Unk570::Unk30 *unk30, RED4ext::vehicle::MaterialFx *fxLookup,
                     RED4ext::Transform *a4, RED4ext::Transform *a5, bool physicalMaterialChange, bool conditionChange,
                     bool condition) {
  auto modeChanged = ((FlightStatus*)&fxLookup->normal.particle.extra_byte_for_fun)->hasChanged;
  return SkidMarkEffectStart_Original(unk570, unk30, fxLookup, a4, a5, physicalMaterialChange || modeChanged, conditionChange, condition);
}